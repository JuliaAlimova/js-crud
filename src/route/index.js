...
Track.create('11 PM', 'Maluma', '/img/track-5.png')

Track.create('Інша любов', 'Enleo', '/img/track-6.png')
...
router.post('/spotify-create', function (req, res) {
  ...
  if (!name) {
    return res.render('alert', {
      ...
      message: 'Error!',
      info: 'Enter playlist name',
      success: false,
      linkBack: isMix
        ? 'spotify-create?isMix=true'
        : 'spotify-create',
      linkBackText: 'spotify create',
    })
  }
...
router.get('/spotify-playlist', function (req, res) {
  ...
  if (!playlist) {
    return res.render('alert', {
      ...
      message: 'Error!',
      info: 'Not found playlist',
      success: false,
      linkBack: 'spotify',
      linkBackText: 'spotify',
    })
  }
